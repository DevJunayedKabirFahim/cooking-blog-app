                    ...
                    <div class="col-lg-9 col-md-7 col-sm-7">
                        ...
                        <article class="blog_post style_three" >
                            <div class="post_img mt-0 mb-4 mb-lg-0" >
                                ...
                                <a href="{{route('blog-detail', ['id' => $blog->id])}}"><img src="{{asset($blog->image)}}" alt="img" height="300" width="450"></a>
                            </div>

                            <div class="post_content">
                                <div class="post_content_inner" >
                                    <div class="post_header">
                                        <div class="tags"><a href="#" class="bg-one">{{$blog->category->name}}</a></div>
                                        <h1 class="post_title">
