                ...
                <div class="card-body">
                    ...
                    <form action="{{route('blog.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-7">
                                <input id="title" type="text" name="title" class="form-control" placeholder="Write blog title"/>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <textarea name="description" id="description" class="summernote" placeholder="Write Blog description"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                <input type="submit" class="btn btn-primary rounded-2" value="Create New Blog">
                            </div>
                        </div>
                    </form>
                </div>
